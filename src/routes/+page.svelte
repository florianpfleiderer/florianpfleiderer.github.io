  ...
  <div class="fixed inset-0 flex items-center justify-center">
    ...
    >
      ...
      <div class="flex-1 space-y-8 lg:pr-8">
        <div class="space-y-6">
          <h1
            class="text-5xl lg:text-6xl font-bold text-black dark:text-blue-300"
          >
            Florian Pfleiderer
          </h1>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center gap-6">
            ...
            <a href="mailto:florian@pfleiderer.at" class="social-link">
              <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                <path
                  d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-20.728c-.904 0-1.636-.732-1.636-1.636v-13.909c0-.904.732-1.636 1.636-1.636h20.728c.904 0 1.636.732 1.636 1.636zm-2.025 1.687l-7.975 6.957-7.975-6.957v10.781h15.95v-10.781zm-.299-1.687h-15.352l7.975 6.957 7.377-6.957z"
                />
              </svg>
            </a>
          </div>
      ...
      <div
        class="flex-1 lg:min-w-[420px] backdrop-blur-sm bg-white/5 dark:bg-black/5 p-6 lg:p-8 rounded-xl border border-neutral-200 dark:border-neutral-800"
      >
        <h2
          class="text-xl lg:text-2xl font-semibold text-black dark:text-blue-200 mb-4 lg:mb-6"
        >
          Core Competencies
        </h2>
