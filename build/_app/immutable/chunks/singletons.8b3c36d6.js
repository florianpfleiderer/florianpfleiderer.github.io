import { R as d, s as m } from "./index.6f50c499.js";
const u = [];
function p(e, t = d) {
  let n;
  const o = new Set();
  ...
  return { set: a, update: c, subscribe: r };
}
var h;
const E =
  ((h = globalThis.__sveltekit_14wngba) == null ? void 0 : h.base) ?? "";
var k;
const R =
    ((k = globalThis.__sveltekit_14wngba) == null ? void 0 : k.assets) ?? E,
  A = "1740250453235",
...
function P(e, t) {
  ...
  return { url: n, external: a, target: o, download: c };
}
function V(e) {
  let t = null,
    n = null,
...
function g(e) {
  ...
  function c(r) {
    ...
    return t.subscribe((i) => {
      (s === void 0 || (n && i !== s)) && r((s = i));
    });
  }
  return { notify: o, set: a, subscribe: c };
}
function S() {
  ...
  async function o() {
    clearTimeout(n);
    try {
      const a = await fetch(`${R}/_app/version.json`, {
        headers: { pragma: "no-cache", "cache-control": "no-cache" },
      });
      if (!a.ok) return !1;
      const r = (await a.json()).version !== A;
...
const q = { url: g({}), page: g({}), navigating: p(null), updated: S() };
export {
  O as I,
  _ as P,
  x as S,
